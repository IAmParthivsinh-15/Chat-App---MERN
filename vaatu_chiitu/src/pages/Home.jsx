...
import usePendingReq from "../hooks/usePendingReq.js";

const Home = () => {
  const { friendSearchUser, pendingReqs, setPendingReq } = useConversation();
            ...
            <div className=" relative  h-full w-full">
              <div className="fixed top-[87px] w-[360px] h-[210px] bg-[#404040] z-50 rounded-xl">
                ...
                {friendSearchUser?.responseData ? (
                  ...
                  <div>{username ? <div>{message}</div> : <div></div>}</div>
                )}
              ...
              <div className="mt-[58%]">
                {requests && requests.length > 0 && (
                  ...
                  >
                    <img
                      src={requests[0].profilePic} // Corrected property name
                      className="w-[45px] h-[45px] rounded-full mt-2 ml-6"
                    />
                    <div className="flex flex-col pl-4 my-auto">
